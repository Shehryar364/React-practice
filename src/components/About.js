...
//           <div id="collapseOne" className="collapse show" aria-labelledby="headingOne"style={myStyle} data-parent="#accordionExample">
...
//       <button classNameName='btn btn-primary' onClick={toggleStyle}> {btnstyle}</button>
//       </div>
